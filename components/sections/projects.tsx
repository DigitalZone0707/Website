    ...
    <section id="projects" className="py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          title="Featured"
          highlight="Projects"
          description="Explore our curated list of featured projects."
        />
        ...
        {loading && (
          <div className="flex justify-center items-center h-64">
            <div role="status">
              <svg
                aria-hidden="true"
                className="inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-[#e2781b]"
                viewBox="0 0 100 101"
                fill="none"
        ...
        {error && (
          <div className="flex justify-center items-center h-64">
            <p className="text-[#e2781b]">Unable to fetch projects</p>
          </div>
        )}
